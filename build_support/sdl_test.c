...
static const char *FONT_PATH = "./resources/fonts/outfit/outfit.ttf";
static const char *IMG_PATH = "./test_media/images/image.png";
static const char *MUSIC_PATH = "./test_media/audio/music.wav";
